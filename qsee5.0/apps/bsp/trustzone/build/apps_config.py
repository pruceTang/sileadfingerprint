...
# keymaster
keymaster_dict = {
  'aliases' : ['keymaster', 'keymaster64'],
  'arch' : 'scorpion',
  'tags' : ['KEYMASTER_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/keymaster/src/SConscript',
}
...
keymaster64_dict = {
  ...
  'arch' : 'A53_64',
  'tags' : ['KEYMASTER_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/keymaster64/src/SConscript',
}
...
#======================================================
# ifdef VENDOR_EDIT
# Ran.Chen@BSP.Fingerprint.Basic, 2018/04/16, add for fingerrpint_fpc
fingerprint_dict = {
  'aliases' : ['fingerprint'],
  'arch' : 'scorpion',
  'tags' : ['FINGERPRINT_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/fpc/build/SConscript',
}
addParams('fingerprint', fingerprint_dict)
# Ran.Chen@BSP.Fingerprint.Basic, 2018/04/16, add for goodix_O
goodixfp_O_dict = {
  'aliases' : ['goodixfp_O'],
  'arch' : 'scorpion',
  'tags' : ['GOODIXFP_O_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/goodixfp_o/build/SConscript',
}
addParams('goodixfp_O', goodixfp_O_dict)
# Ran.Chen@BSP.Fingerprint.Basic, 2018/04/16, add for goodixfp_optical GT95
goodixfp_optical_dict = {
  'aliases' : ['goodixfp_optical'],
  'arch' : 'scorpion',
  'tags' : ['GOODIXFP_OPTICAL_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/goodixfp_optical/build/SConscript',
}
addParams('goodixfp_optical', goodixfp_optical_dict)
# Ran.Chen@BSP.Fingerprint.Basic, 2018/04/16, add for facereg_o
facereg_o_dict = {
  'aliases' : ['facereg_o'],
  'arch' : 'scorpion',
  'tags' : ['FACEREG_O_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/facereg_o/build/SConscript',
}
sileadta_dict = {
  'aliases' : ['sileadta'],
  'arch' : 'scorpion',
  'tags' : ['SILEADTA_IMAGE'],
  'sconspath' : '${BUILD_ROOT}/apps/securemsm/trustzone/qsapps/sileadta/build/SConscript',
}
addParams('sileadta', sileadta_dict)
#endif /* VENDOR_EDIT */
#======================================================
# seccamdemo64
seccamdemo64_dict = {

...
const cf_register_t reg_normal_gsl6150b[] = {
    ...
    {0xFF080200, 0x80888A80},
    {0xFF080204, 0x80888A80},
    {0xFF080208, 0x80888A80},
    {0xFF08020C, 0x80888A80},
    {0xFF080210, 0x80888A80},
    {0xFF000020, 0x00010201},
    {0xFF00002C, 0x00000205},
    {0xFF08000C, 0x0012729C},
};

const cf_register_t reg_fg_detect_gsl6150b[] = {
    {0xFF000020, 0x00010201},
    {0xFF00002C, 0x00000205},
    {0xFF08000C, 0x00127272},
};

const cf_register_t reg_partial_gsl6150b[] = {
...
const cf_register_t reg_full_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
...
const cf_register_t reg_frm_start_gsl6150b[] = {
    {0xFF080024, 0x00000000},
};

const cf_register_t reg_ds_start_gsl6150b[] = {
    {0xFF080024, 0x03000000},
};

const cf_register_t reg_stop_gsl6150b[] = {
};

const cf_register_t reg_downint_gsl6150b[] = {
...
const cf_register_t reg_vkeyint_gsl6150b[] = {
    {0x000000BF, 0x00000000},
    {0xFF080034, 0x10001000},
    {0xFF080038, 0x0F000020},
    {0xFF080124, 0x00000018},
...
const cf_register_t reg_upint_gsl6150b[] = {
    {0x000000BF, 0x00000000},
...
const cf_register_t reg_nav_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
    {0xFF080150, 0x00500007},
    {0xFF080154, 0x00010000},
...
const cf_register_t reg_nav_hg_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
...
const cf_register_t reg_nav_ds_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
    {0xFF080150, 0x00500007},
    {0xFF080154, 0x00010000},
    {0xFF080054, 0x00000140},
...
const cf_register_t reg_nav_hg_ds_gsl6150b[] = {
};

const cf_register_t reg_snr_gsl6150b[] = {
...
const cf_register_t reg_deadpix1_gsl6150b[] = {
    {0xFF000020, 0x00010101},
    {0xFF00002C, 0x00000101},
    {0xFF08000C, 0x00127272},
};

const cf_register_t reg_deadpix2_gsl6150b[] = {
    {0xFF000020, 0x00010101},
    {0xFF00002C, 0x00000101},
    {0xFF08000C, 0x00127272},
};

const cf_register_t reg_deadpix3_gsl6150b[] = {
    {0xFF000020, 0x00010101},
    {0xFF00002C, 0x00000101},
    {0xFF08000C, 0x00127272},
};

const cf_register_t reg_hg_coverage_gsl6150b[] = {
...
const cf_register_t reg_hwagc_read_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
    {0xFF080054, 0x00000500},
    {0xFF080150, 0x00500007},
    {0xFF080154, 0x00010000},
...
const cf_register_t reg_hwcov_start_gsl6150b[] = {
    {0xFF080024, 0x01000000},
};

const cf_register_t reg_hwagc_start_gsl6150b[] = {
    {0xFF080024, 0x00000001},
};

const cf_register_t reg_base_ori_gsl6150b[] = {
    {0xFF0A0010, 0x00000001},
    {0xFF080054, 0x00000500},
    {0xFF080150, 0x00500007},
    {0xFF080154, 0x00010000},
...
const cf_register_t reg_auto_adjust_gsl6150b[] = {
...
const int32_t FineTune_param_gsl6150b[] = {
...
const int32_t Navi_param_gsl6150b[] = {
    0,          3,          8,          3,          8,          9,          128,        3,
    2,          8,          64,         27,         1,          2,          0,          2,
...
const int32_t Cover_param_gsl6150b[] = {
    64,         80,         2,          2,          10,
};

const int32_t Base_param_gsl6150b[] = {
...
const int32_t Reduce_param_gsl6150b[] = {
    32,         0,          1,          24,         0,          40,         0,          1,
};

const cf_dev_ver_t dev_ver_gsl6150b[] = {
    {0x6152B003, 0x6152B003, 0x00000000},
    {0x6152B004, 0x6152B004, 0x00000000},
    {0x6152B005, 0x6152B005, 0x00000000},
    {0x6152B006, 0x6152B006, 0x00000000},
    {0x6152B007, 0x6152B007, 0x00000000},
};

cf_set_t cfg_gsl6150b = {
    .dev = {
        (cf_dev_ver_t *)dev_ver_gsl6150b,
        ARRAY_SIZE(dev_ver_gsl6150b),
        0,
    },
    ...
    .pb = {
        .param = {
            {
                (int32_t *)FineTune_param_gsl6150b,
                ARRAY_SIZE(FineTune_param_gsl6150b),
                0,
            },
            {
                (int32_t *)Navi_param_gsl6150b,
                ARRAY_SIZE(Navi_param_gsl6150b),
                0,
            },
            {
                (int32_t *)Cover_param_gsl6150b,
                ARRAY_SIZE(Cover_param_gsl6150b),
                0,
            },
            {
                (int32_t *)Base_param_gsl6150b,
                ARRAY_SIZE(Base_param_gsl6150b),
                0,
            },
            {
                (int32_t *)Reduce_param_gsl6150b,
                ARRAY_SIZE(Reduce_param_gsl6150b),
                0,
            },
        },
        .agc = {
    ...
    .cfg = {
        ADD_CFG(normal_gsl6150b),
        ADD_CFG(fg_detect_gsl6150b),
        ADD_CFG(partial_gsl6150b),
        ADD_CFG(full_gsl6150b),
        ADD_CFG(frm_start_gsl6150b),
        ADD_CFG(ds_start_gsl6150b),
        ADD_CFG(stop_gsl6150b),
        ADD_CFG(downint_gsl6150b),
        ADD_CFG(vkeyint_gsl6150b),
        ADD_CFG(upint_gsl6150b),
        ADD_CFG(nav_gsl6150b),
        ADD_CFG(nav_hg_gsl6150b),
        ADD_CFG(nav_ds_gsl6150b),
        ADD_CFG(nav_hg_ds_gsl6150b),
        ADD_CFG(snr_gsl6150b),
        ADD_CFG(deadpix1_gsl6150b),
        ADD_CFG(deadpix2_gsl6150b),
        ADD_CFG(deadpix3_gsl6150b),
        ADD_CFG(hg_coverage_gsl6150b),
        ADD_CFG(hwagc_read_gsl6150b),
        ADD_CFG(hwcov_start_gsl6150b),
        ADD_CFG(hwagc_start_gsl6150b),
        ADD_CFG(base_ori_gsl6150b),
        ADD_CFG(auto_adjust_gsl6150b),
    },
};

#endif /* __SILEAD_FP_GSL6150B_H__ */

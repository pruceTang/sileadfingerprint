...
public class CalibrateManager {
    ...
    public void calibrate(OpticCmdCallback callback) {
        ...
        testCmd(FingerManager.TEST_CMD_OPTIC_CALIBRATE, data, callback);
    }
    ...
    public void calibrateStep(int step, OpticCmdCallback callback) {
        ...
        testCmd(FingerManager.TEST_CMD_OPTIC_CALIBRATE_STEP, data, callback);
    }
    ...
    public int onOpticCmdResult(int cmdId, byte[] result) {
        ...
        switch (cmdId) {
            case FingerManager.TEST_CMD_OPTIC_CALIBRATE: {
                return onCalibrateResult(cmdId, result);
            }
            case FingerManager.TEST_CMD_OPTIC_CALIBRATE_STEP: {

...
public class TestResultXml {
    ...
    public static int init(Context context, File path, String name) {
        ...
        mSaveImgTestResult = SharedPreferencesData.loadDataBoolean(context, FingerSettingsConst.FP_SETTINGS_CONFIG, FingerSettingsConst.FP_SETTINGS_FRRFAR_IMG_RESULT_NAME, 
                                FingerSettingsConst.FP_SETTINGS_FRRFAR_IMG_RESULT_DEFAULT);
